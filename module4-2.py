...
# set tuple for custom substitutions
substitute_tuple = ((' iz', ' is'), ('x“iz', 'x “iz'), ('tex.', 'text.'),
                    ('these text', 'this text'),
                    ('add it to the end of this paragraph.', 'add it to the end of this paragraph.'
                    + new_sentence_from_last_words(initial_string)))

# call function to make all sentences capitalized
cap_sentences = capitalize_sentences(initial_string)
# call function to make custom substitutions
final_string = replacements(cap_sentences, substitute_tuple)
# output results
output('initial', initial_string)
output('final', final_string)
