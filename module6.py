...
class BatchLoadClass:
    ...
    def batch_parser(self, batch_file):
        ...
        self.records_number = len(self.parse_lines)
        for i in self.parse_lines:
            ...
            if re.search('^Weather forecast$', self.parse_line[0]):
                ...
                try:
                    ...
                    self.par3 = module4.capitalize_sentences(self.parse_line[2])
                    self.par4 = module4.capitalize_sentences(self.parse_line[3])
                    ...
                    self.invalid_file_path = os.path.dirname(f'{self.path}')
                    self.invalid_file = open(f'{self.invalid_file_path}/invalid_records.txt', 'a')
                ...
                self.invalid_file.write(f'{feed.datetime_string}\t{self.parse_line}\n')
                self.invalid_file.close()
        print(f'{self.records_number} records have been processed. '
